...
<body>
  ...
  <div class="right"><center>
   <h1>SECOND TERM(II)</h1>
  <a href="sci.php"><button>Term I</button></a>
  <a href="sci2.php"><button>Term II</button></a>
  <a href="sci3.php"><button>Term III</button></a>
  </center>
  <form method="POST">
    <?php
    include 'conn.php';
  ...
  if (isset($_POST['add'])) {
    ...
    $update="UPDATE p1 SET sci2='$math', sci2_exam='$exam' WHERE student_name='$stn'";
  ...
  ?>
    ...
    <label>science test</label>
    <input type="number" name="math">
    <label>science exam</label>
