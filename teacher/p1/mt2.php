...
<body>
  ...
  <a href="math.php"><button>Term I</button></a>
  <a href="mt2.php"><button>Term II</button></a>
  <a href="mt3.php"><button>Term III</button></a>
  </center>
  <form method="POST">
    <?php
    include 'conn.php';
  ...
  if (isset($_POST['add'])) {
    ...
    $update="UPDATE p1 SET math2='$math', math2_exam='$exam' WHERE student_name='$stn'";
  ...
  ?>
    ...
    <label>math test</label>
    <input type="number" name="math">
    <label>math exam</label>
