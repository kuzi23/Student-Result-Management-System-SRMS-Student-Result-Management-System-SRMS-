...
<body>
  ...
  <a href="sst.php"><button>Term I</button></a>
  <a href="sst2.php"><button>Term II</button></a>
  <a href="sst3.php"><button>Term III</button></a>
  </center>
  <form method="POST">
    <?php
    include 'conn.php';
  ...
  if (isset($_POST['add'])) {
    ...
    $update="UPDATE p1 SET sst2='$math', sst2_exam='$exam' WHERE student_name='$stn'";
  ...
  ?>
    ...
    <label>sst test</label>
    <input type="number" name="math">
    <label>sst exam</label>
