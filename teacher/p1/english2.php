...
<body>
  ...
  <a href="english.php"><button>Term I</button></a>
  <a href="english2.php"><button>Term II</button></a>
  <a href="english3.php"><button>Term III</button></a>
  </center>
  <form method="POST">
    <?php
    include 'conn.php';
  ...
  if (isset($_POST['add'])) {
    ...
    $update="UPDATE p1 SET english2='$math', english2_exam='$exam' WHERE student_name='$stn'";
